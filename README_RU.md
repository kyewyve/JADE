...
<h1> Доступен следующий функционал: </h1>
<h2> 1. Фон </h2>
**
Заменяет фон в лобби, профиле призывателя, ТФТ и так далее.
**

Для его активации вам необходимо активировать нужный пункт в меню настроек клиента.

<img width="772" height="596" alt="image" src="https://github.com/user-attachments/assets/c6e957b8-bd30-4b18-a865-b03ee11068f8" />


Фон настраивается с помощью кнопки шестеренки, которая расположена рядом со значком призывателя.
...
Рамка настраивается с помощью кнопки шестеренки, которая находится в меню настроек профиля.
...
Иконка настраивается с помощью кнопки шестеренки, которая находится в меню настроек профиля.
...
Титул настраивается с помощью кнопки шестеренки, которая находится в меню настроек профиля.
...
Баннер настраивается с помощью кнопки шестеренки, которая находится в меню настроек профиля.

<img width="281" height="183" alt="image" src="https://github.com/user-attachments/assets/d8325ab5-6ab3-4283-9bc8-841745526670" />
...
---
<h2> 2. Статистика проигрыша\победы </h2>
...
---
<h2> 3. Кнопка скрытия списка друзей </h2>
